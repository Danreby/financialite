...
<StatMini label="Total de cartões" value={localCards.length} icon="" />
<StatMini label="Com vencimento" value={cardsWithDueDay.length} icon="" />
<StatMini label="Sem vencimento" value={cardsWithoutDueDay.length} icon="" />
</div>
</FadeInItem>
...
>
<p className="text-xs font-medium text-gray-700 dark:text-gray-300 truncate" title={card.name}>{card.name}</p>
