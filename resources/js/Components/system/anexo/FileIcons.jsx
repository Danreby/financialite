...
export function PdfIcon({ className = 'w-5 h-5' }) {
    return (
        ...
        >
            ...
            <path d="M10 12h-2v6h2" />
            <path d="M14 12h2v6h-2" />
            <path d="M10 15h2" />
        </svg>
    );
}

export function SpreadsheetIcon({ className = 'w-5 h-5' }) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export function getFileIcon(iconType, className = 'w-5 h-5') {
    ...
    const IconComponent = icons[iconType] || FileIcon;
...
export function getFileIconColor(iconType) {
    const colors = {
        ...
        document: 'text-indigo-500 dark:text-indigo-400',
